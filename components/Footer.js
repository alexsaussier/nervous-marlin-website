    ...
    <div className="container mx-auto flex flex-wrap justify-between">
        ...
        <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <p className="flex items-center">
              ...
              Phone: +55 73 99944-0050
            </p> 
            <p className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 mr-2 fill-current">
                <path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/>
              </svg>
              <a href="mailto:leonardoforesti69@gmail.com" className="hover:text-gray-300"> Email: leo@nervousmarlin.com</a>
            </p>
        </div>
        <div className="w-full md:w-1/4">
            ...
            <div className="flex flex-col space-x-4">
                ...
                <div className="mt-2 flex space-x-4 opacity-50">
